...
const productToElement = (suggestion, categoryId) => {
  ...
  const productHref = `/product/detail.html?product_no=${product.idOnStore}&cate_no=${categoryId}&display_group=1`;
  ...
  product.decorationImages = product.decorationImages || []; // TODO remove
